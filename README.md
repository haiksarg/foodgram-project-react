...
![foodgram_workflow](https://github.com/haiksarg/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
```
sudo docker-compose exec web python manage.py csv_in_db
```
...
``` git@github.com:haiksarg/foodgram-project-react.git ``` 
